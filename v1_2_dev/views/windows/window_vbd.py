    ...
    def __init__(self):
        self.layout = [[sg.Text('VBOX + Devices')],
                          ...
                          [sg.Button('kali_dojo-vbox'), sg.Button('xK'), sg.Button('sshK'), sg.Button('scpK'),
                           sg.Button('scpK>')],
                          [sg.Button('vbox-w7',button_color=('white', '#00406B')), sg.Button('w7savex', button_color=('springgreen4', '#9B0023')), sg.Button('sshw7'), sg.Button('scpw7'),
                           sg.Button('scpw7>')],
        ...
        self.xwindow = sg.Window("VBOX BUTTONS",
                         self.layout,
